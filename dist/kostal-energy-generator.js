...
exports.KostalEnergyGenerator = void 0;
const kostal_energy_accessory_1 = require("./kostal-energy-accessory");
class KostalEnergyGenerator {
    constructor(log, config, api) {
        ...
        this.pollingInterval = 30; // Default 30 seconds, now configurable
     ...
     */
    shouldLogData(newData) {
        if (this.logData.length < 2)
            return true; // Erstes Mal loggen
...
exports.KostalEnergyGenerator = KostalEnergyGenerator;
//# sourceMappingURL=kostal-energy-generator.js.map